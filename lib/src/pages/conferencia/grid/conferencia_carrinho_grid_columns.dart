    ...
    _columns.add(
      GridColumn(
        ...
        label: Container(
          padding: padding,
          alignment: Alignment.centerLeft,
          child: const Text('codConferente'),
        ),
      ),
    );
    ...
    _columns.add(
      GridColumn(
        ...
        label: Container(
          padding: padding,
          alignment: Alignment.centerLeft,
          child: const Text('Hr. Conferencia'),
        ),
      ),
    );
