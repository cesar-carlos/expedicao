...
class CarrinhoEventRepository implements EventContract {
  ...
  void _onInsert() {
    const event = 'carrinho.insert.listen';
  ...
  void _onUpdate() {
    const event = 'carrinho.update.listen';
    _appSocket.socket.on(event, (data) {
      _listener
  ...
  void _onDelete() {
    const event = 'carrinho.delete.listen';
    _appSocket.socket.on(event, (data) {
      _listener
